...
latex_documents = [
    (master_doc, 'mechkit.tex', 'mechkit documentation',
     'Julian Karl Bauer', 'manual'),
]
...
man_pages = [
    (master_doc, 'mechkit', 'mechkit documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mechkit', 'mechkit documentation',
     author, 'mechkit', 'One line description of project.',
     'Miscellaneous'),
]
